      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            <Button className="ml-4 bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-semibold">
              Get Started
            </Button>
          </div>
        ...
        {isOpen && (
          ...
          >
            <div className="container mx-auto px-4 py-4 space-y-2">
              ...
              <Button className="w-full bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-semibold mt-2">
                Get Started
              </Button>
            </div>
          </motion.div>
